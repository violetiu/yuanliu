...
const component: IComponent = {
    isTemplate: true, key: "flow_base", label: "base", icon: "bi bi-skip-forward", type: "flow_base", group: "flow",
    styles: {
        root: "display:flex;align-items:center;justify-content:center;padding:5px;margin:5px;border-radius:5px;",
        block: "flex:1;height:50px;width:100px;background:var(--theme-color);display:flex;align-items:center;justify-content:center;color:#fff;border-radius:5px;",
